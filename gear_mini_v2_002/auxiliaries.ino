    ...
    if ((currentStatus.current_gear_Selected == 20)||(currentStatus.current_gear_Selected == 21))
        {
          if ((configPage1.paddle_change_up != 0)||(configPage1.sport_change_up !=0))           //if up paddle or sport up is activated
            {
              if ((BIT_CHECK(currentStatus.digIn, ((configPage1.paddle_change_up -1)  & B00011111)) == inpin2binary[(configPage1.paddle_change_up -1) & B00011111])||
                    (BIT_CHECK(currentStatus.digIn, ((configPage1.sport_change_up -1)  & B00011111)) == inpin2binary[(configPage1.sport_change_up -1) & B00011111]))  
                {
              ...
              else if ((BIT_CHECK(currentStatus.digIn, ((configPage1.paddle_change_up -1)  & B00011111)) != inpin2binary[(configPage1.paddle_change_up -1) & B00011111])||
                         (BIT_CHECK(currentStatus.digIn, ((configPage1.sport_change_up -1)  & B00011111)) != inpin2binary[(configPage1.sport_change_up -1) & B00011111]))
                {
                  if (currentStatus.change_up_current == 1)
                    {
          ...
          if ((configPage1.paddle_change_down != 0)||(configPage1.sport_change_down !=0))           //if paddle down or sport down is activated
            {      
              if ((BIT_CHECK(currentStatus.digIn, ((configPage1.paddle_change_down -1)  & B00011111)) == inpin2binary[(configPage1.paddle_change_down -1) & B00011111])||
                    (BIT_CHECK(currentStatus.digIn, ((configPage1.sport_change_down -1)  & B00011111)) == inpin2binary[(configPage1.sport_change_down -1) & B00011111]))
                {
              ...
              else if ((BIT_CHECK(currentStatus.digIn, ((configPage1.paddle_change_down -1)  & B00011111)) != inpin2binary[(configPage1.paddle_change_down -1) & B00011111])||
                        (BIT_CHECK(currentStatus.digIn, ((configPage1.sport_change_down -1)  & B00011111)) != inpin2binary[(configPage1.sport_change_down -1) & B00011111]))
                {
                  if (currentStatus.change_down_current == 1)
                    {
