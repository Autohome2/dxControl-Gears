...
#define DISPLAY_CS 7                //pin to use for CS
#define DISPLAY_DC 6                //pin to use for DC
...
const unsigned char simple_remote_signature[]    = "speeduino_dxControl-Gears 201711"; 
const unsigned char simple_remote_RevNum[] = "speeduino 201711_dxControl-Gears V2.002";
