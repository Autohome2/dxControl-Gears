...
void direct_sendValues(uint16_t offset, uint16_t packetLength, uint8_t cmd)
{
  ...
  fullStatus[26] = lowByte(currentStatus.digOut);    
  fullStatus[27] = highByte(currentStatus.digOut);
  fullStatus[28] = lowByte(currentStatus.Analog[1]);
  fullStatus[29] = highByte(currentStatus.Analog[1]);
  fullStatus[30] = lowByte(currentStatus.Analog[2]);
  fullStatus[31] = highByte(currentStatus.Analog[2]);
  fullStatus[32] = lowByte(currentStatus.Analog[3]);
  fullStatus[33] = highByte(currentStatus.Analog[3]);
  fullStatus[34] = lowByte(currentStatus.Analog[4]);
  fullStatus[35] = highByte(currentStatus.Analog[4]);  
  fullStatus[36] = lowByte(currentStatus.Analog[5]);
  fullStatus[37] = highByte(currentStatus.Analog[5]);
  fullStatus[38] = lowByte(currentStatus.Analog[6]);
  fullStatus[39] = highByte(currentStatus.Analog[6]);
  fullStatus[40] = lowByte(currentStatus.Analog[7]);
  fullStatus[41] = highByte(currentStatus.Analog[7]);
  fullStatus[42] = lowByte(currentStatus.Analog[8]);
  fullStatus[43] = highByte(currentStatus.Analog[8]);
  fullStatus[44] = lowByte(currentStatus.Analog[9]);
  fullStatus[45] = highByte(currentStatus.Analog[9]);
  fullStatus[46] = lowByte(currentStatus.Analog[10]);
  fullStatus[47] = highByte(currentStatus.Analog[10]);
  fullStatus[48] = lowByte(currentStatus.Analog[11]);
  fullStatus[49] = highByte(currentStatus.Analog[11]);
  fullStatus[50] = lowByte(currentStatus.Analog[12]);
  fullStatus[51] = highByte(currentStatus.Analog[12]);  
  fullStatus[52] = lowByte(currentStatus.Analog[13]);
  fullStatus[53] = highByte(currentStatus.Analog[13]);
  fullStatus[54] = lowByte(currentStatus.Analog[14]);
  fullStatus[55] = highByte(currentStatus.Analog[14]);
  fullStatus[56] = lowByte(currentStatus.Analog[15]);
  fullStatus[57] = highByte(currentStatus.Analog[15]);
  fullStatus[58] = lowByte(currentStatus.Analog[16]);
  fullStatus[59] = highByte(currentStatus.Analog[16]);    
